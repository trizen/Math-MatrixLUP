...
B<Math::MatrixLUP> provides generic support for matrix operations and LUP decomposition, allowing any type of numbers inside the matrix, including L<Math::AnyNum> objects.
